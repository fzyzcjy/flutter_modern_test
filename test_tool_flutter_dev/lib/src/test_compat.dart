// ignore_for_file: implementation_imports, omit_local_variable_types, avoid_print, comment_references
...
import 'package:test_tool_flutter_dev/src/log.dart';
...
void runTestsInDeclarer(Declarer declarer) {
...
void _sendTestsInfo(Group root) {
...
class _Reporter {
  ...
  void _onTestStarted(LiveTest liveTest) {
    ...
    _subscriptions.add(liveTest.onMessage.listen((Message message) {
      ...
      // NOTE XXX add
      TestToolRpcClient.send(Event(
          runnerOnMessage: RunnerOnMessage(
